...
describe('plugin-user', () => {
  describe('User', () => {
    ...
    describe('#updateName()', () => {
      it('requires one of `givenName` `familyName` or `displayName`', () => assert.isRejected(userService.updateName(), /One of `givenName` or `familyName` or `displayName` is required/));
    });
